                        ...
                        <?php
                            ...
                            while($row=mysqli_fetch_assoc($result)) {
                                ...
                                echo '<tr>
                                    ...
                                    <td>' .$username. '</td>
                                    <td>
                                        <p class="mt-2">First Name : <b>' .$firstName. '</b></p>
                                    ...
                                    <td class="text-center">
                                        <div class="row mx-auto" style="width:112px">
                                            <button class="btn btn-sm btn-primary mx-auto mb-2" style="width:80%;" data-toggle="modal" data-target="#editUser' .$Id. '" type="button">Edit</button>';
                                            if($Id == 1) {
                                                echo '<button class="btn btn-sm btn-danger mx-auto" style="width:80%;" disabled>Delete</button>';
                                            }
                                            else {
                                                echo '<form action="partials/_userManage.php" method="POST">
                                                        <button name="removeUser" class="btn btn-sm btn-danger"  style="width:100%;">Delete</button>
