    ...
    <!-------------------------------- Donuts container starts here -------------------------------->
        ...
        <?php
            ...
            while($row1 = mysqli_fetch_assoc($resultCat)){
                $catId = $row1['categorieId'];
                $catName = $row1['categorieName']; ?> 
                    <div class="row" style="border-top: 1px solid lightgrey;  padding-top: 20px;">
                        <h1 style="font-size: 24px; color: #24282B; margin: 16px 0px; font-weight: 600;">
                        <a style="text-decoration: none;"> <?php echo $catName ?> </a></h1>
                    </div>
                    <div class="row">
                        <?php
                            $sql = "SELECT * FROM `donut` where donutCategorieId = $catId";
                            ...
                            while($row = mysqli_fetch_assoc($result)){
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item mb-4">
                                    <div class="card h-100" style="border-radius: 20px;">
                                        ...
                                        <div class="card-body">
                                            <div class="card-title" style="font-size: 18px; font-weight: bold; text-align: center; margin: 5px 0px; width: 10 0%; color: rgb(17, 17, 17);">
                                                <?php echo $donutName ?>
                                            </div>
